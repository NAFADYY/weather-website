...
function displayCurrent(a, t) {
  if (null != t) {
    ...
    let n = `<div class="today forecast">\n    <div class="forecast-header"  id="today">\n    <div class="day">${
      ...
      t.condition.text
    }</div>\n    <span><i class="fa-solid fa-umbrella-beach fa-2xl"></i> 20%</span>\n\t\t\t\t\t\t\t\t<span><i class="fa-solid fa-wind fa-2xl"></i> 18km/h</span>\n\t\t\t\t\t\t\t\t<span><i class="fa-solid fa-compass fa-2xl"></i> East</span>\n    </div>\n</div>`;
